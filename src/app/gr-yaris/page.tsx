...
export default function Page() {
  ...
  const sections: SectionData[] = [
    {
      header: "Overview",
      body: "The Toyota GR Yaris is a rally-inspired hot hatch, built as a homologation special to deliver exceptional performance in a compact package. Developed with input from Toyota’s Gazoo Racing (GR) team, it features a lightweight chassis, all-wheel drive, and a turbocharged engine, making it one of the most exciting modern hatchbacks. Unlike a standard Yaris, the GR Yaris has a bespoke three-door body, aggressive aerodynamics, and motorsport-level engineering, ensuring a pure driver-focused experience.",
      src: "/yaris2.jpg",
    ...
    {
      header: "Performance",
      body: "Under the hood is a 1.6L turbocharged three-cylinder engine, producing 257-268 horsepower and 266 lb-ft of torque—one of the most powerful three-cylinder engines in the world. Power is sent through a GR-FOUR all-wheel-drive system, featuring adjustable torque distribution for maximum grip in all conditions. Weighing just 1,280 kg (2,822 lbs), the GR Yaris delivers razor-sharp handling, a short-ratio 6-speed manual transmission, and motorsport-level performance, making it an absolute blast on both road and track.",
      src: "/yarisEngine.jpg",
      alt: "GR Yaris Engine",
      imagePosition: "right",
    },
